  ...
  return (
    <div style={{
      ...
      <div onClick={e => e.stopPropagation()} className="fade-in" style={{
        ...
        boxShadow: "0 24px 64px rgba(0,0,0,0.5), 0 0 80px rgba(255,255,255,0.03)",
      }}>
        {/* Pulsar icon */}
        <div style={{
        ...
        <h2 style={{ margin: "0 0 8px", fontSize: "18px", fontWeight: "700", color: "#FFFFFF" }}>
          Sign in with Microsoft
        </h2>

        {phase === "waiting" && (
          <div>
            <p style={{ color: "var(--text-muted)", fontSize: "13px", marginBottom: "20px" }}>Connecting to Microsoft...</p>
            <div style={{
        ...
        {phase === "code" && code && (
          <>
            ...
            <div style={{
              ...
              <div style={{ fontSize: "10px", color: "var(--text-muted)", marginBottom: "8px", letterSpacing: "0.15em", fontWeight: "700" }}>ENTER THIS CODE</div>
              <div style={{
        ...
        {phase === "error" && (
          <>
            <div style={{
              fontSize: "13px", color: "var(--accent-red)", padding: "12px 16px", marginBottom: "20px",
